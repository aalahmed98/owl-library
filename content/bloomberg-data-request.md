...
tags:
  ...
  - banking
summary: >-
  Self-contained extraction request for whoever has terminal access. What to
  pull, in priority order, with field names, history depth and the save format.
  No project background needed to execute it.
created: '2026-08-09'
status: draft
space: shared
---
